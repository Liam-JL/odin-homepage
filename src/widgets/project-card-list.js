import { projectsArray } from "../shared/project-storage";

export function renderProjectCardList() {
     const projectCardList = document.getElementById("project-card-list");
     const projects = projectsArray;
     projects.forEach(project => {
        const card = makeProjectCard(project);
        projectCardList.appendChild(card);
     })
}
